...
class OrdersRestControllerForClientIT extends RestAssuredIntegrationTestBase {
    ...
    void checkThatYouCanGetOrdersAsClient() {
        ...
        List<RestOrderDTO> expectedOrders = supperOrderService.getRestOrdersByUserEmail("user4@user.com");

        String base64Credentials = Base64.getEncoder().encodeToString("user4@user.com:test".getBytes());
